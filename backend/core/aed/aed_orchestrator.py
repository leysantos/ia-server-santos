        ...
        emit_evolution_signal(
            {
                ...
                "input_text": text,
                "task_type": "aed_simulation",
                "discipline": "ESTRUTURAL" if "ESTRUTURAL" in understanding.disciplines else understanding.disciplines[0] if understanding.disciplines else "GERAL",
                "output_quality": selection.final_selection_score if hasattr(selection, "final_selection_score") else None,
                "success": True,
                "extra": {
                    "structural_selection": output.get("structural_selection"),
