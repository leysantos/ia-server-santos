...
from experimental.evolution.mutation_engine import MutationProposal
...
class RolloutManager:
    ...
    def _apply_rag_mutation(self, proposal: MutationProposal) -> bool:
        try:
            from experimental.evolution.rag_evolution import get_rag_evolution_store
    ...
    def _record(
        ...
        *,
        ...
        try:
            from experimental.evolution.audit import save_evolution_mutation
