...
from experimental.self_improving.failure_memory import record_failure
...
from experimental.self_improving.patch_validator import validate_patches
...
def _save_patches(patches: list[dict[str, Any]]) -> int:
    from experimental.self_improving.failure_memory import save_patch_proposal
